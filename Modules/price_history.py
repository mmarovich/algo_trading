...
def binance_history():
    ...
    binance_history = binance.fetch_ohlcv('BTC/USDT', timeframe='1d', since=millisec, params={'price': 'index'})
...
def phemex_history():
    ...
    phemex_history = phemex.fetch_ohlcv('BTC/USDT', timeframe='1d', since=millisec, params={'price': 'index'})
